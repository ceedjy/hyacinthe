...
passage(terrain, nord, devant_stix) :-
	write("Tu te réveilles en sursaut."), nl,
	write("Tu te relèves avec difficulté."), nl.

passage(devant_stix, nord, maison) :-
	write("Tu as accepté ton sort."), nl,
	write("Tu rejoins Charon dans sa barque."), nl,
	write("Tu es jugé comme étant une bonne âme et vas à Asphodèle."), nl,
	write("Tu ne reverras plus jamais Apollon et tu ne deviendras jamais un héro."), nl, 
	fin.

passage(devant_stix, est, choix_stix) :- 
	write("Tu n'acceptes pas ton sort."), nl,
	write("Toi : Hadès ! Attendez ! S'il vous plaît, il n'y a aucun moyen de retourner dans le monde des vivants ?"), nl, 
	write("Hadès : Tu veux vraiment essayer de négocier avec moi ?"), nl, 
	write("Hadès : Très bien, tu as de la chance je suis d'humeur joueuse aujourd'hui."), nl, 
	write("Hadès : Faisons ainsi : Les JO des enfers vont bientôt avoir lieu. Si tu parviens à gagner les 3 épreuves alors tu remonteras à la surface."), nl, 
	write("Mais si tu échoues, ton âme m'appartiendra pour toujours et tu seras condamné aux pires punitions du Tartar pour ton insolence."), nl, 
	write("Hadès : Alors mortel ? Que choisi-tu ?"), nl, nl.

passage(choix_stix, nord, maison) :-
	write("Tu ne prends pas de risque."), nl, 
	write("Les punitions du Tartar sont les pires de toutes."), nl, 
	write("Tu rejoins Charon dans sa barque."), nl, 
	write("Tu es jugé et tu passes l'éternité à Asphodèle."), nl, 
	write("Tu ne reverras jamais Apollon et tu ne deviendras jamais un héro."), nl, 
	fin.

passage(choix_stix, est, palais) :-
	write("Toi : Je prends le risque !"), nl, 
	write("** Hadès s'esclaffe **"), nl, 
	write("Hadès : Très bien, qu'il en soit ainsi jeune mortel."), nl,
	write("Le dieu des morts vous téléporte tous les deux à son palais."), nl.

passage(palais, sud, maison) :-
	write("Tu tentes de prendre la fuite !"), nl,
	...
	write("Tu ne deviendras jamais un héro."), nl, 
	fin.
...
passage(palais, ouest, asphodele) :-
	epreuve(ouest, non),
	write("Tu choisis l'épreuve de la course."), nl,
	write("Une nymphe t'accueille et t'habille pour l'épreuve."), nl, 
...
passage(asphodele, sud, asphodele) :-
...
passage(asphodele, est, cours_forest) :-
	write("Vous rentrez dans la boutique 'Cours forest !'."), nl,
	write("Vous y trouvez une magnifique paire de chaussures parfaitement à ta taille mais particulièrement lourde."), nl, 
	write("Et vous trouvez une autre paire de chaussures un peu trop petite mais très légère."), nl, 
	write("Nymphe : Tu prends laquelle ?"), nl. 

passage(cours_forest, ouest, asphodele) :-
	write("Vous sortez de la boutique 'Cours Forest !'"), nl.

passage(asphodele, ouest, ruelle) :-
	write("Tu remarques une petite ruelle sombre à l'ouest et tu t'y engages."), nl, 
	write("La nymphe ne t'a pas vu t'eclipser."), nl,
	write("En fouillant un peu, tu trouves un vieux carton où dedans tu y trouve les chaussures volantes d'Hermès !"), nl,
	write("Tu les mets aux pieds, et en plus elles sont parfaitement à ta taille ! "), nl,
...
passage(ruelle, est, asphodele) :-
	write("Tu retrouves la nymphe."), nl, 
...
passage(ruelle, ouest, fin_parfaite) :-
	...
	write("Tu réussis à remonter dans le monde des vivants sans te faire remarquer."), nl. 

passage(piste, sud, palais) :-
	epreuve(ouest, oui),
	write("Tu retournes au palais en ayant remporté l'épreuve de la course !"), nl.

passage(piste, est, maison) :-  % un piege si le joueur tente d aller la ou il faut pas 
	write("Tu tentes de prendre la fuite !"), nl,
	write("Mais tu te fais rapidement rattraper par Cerbère, le gardien des enfers."), nl, 
	write("Tu es jeté au Tartar sans plus d'explications."), nl, 
...
passage(palais, nord, arene_enfer) :-
	epreuve(nord, non),
	write("Tu choisis l'épreuve du lancer de disque."), nl,
	write("Une nymphe t'accueille et t'habille pour l'épreuve."), nl, 
	write("Vous sortez du palais et vous vous dirigez vers le lieu de l'épreuve."), nl.
...
passage(arene_enfer, sud, maison) :-
	write("Tu restes bloqué devant la table."), nl, 
	write("Le disque d'Apollon t'a boulversé."), nl, 
	write("Bourré de colère, tu le prends et le lance au hasard dans la pièce."), nl, 
...
passage(arene_enfer, est, maison) :-
	write("Tu décides que tout cela ne rime à rien et que les Moires ont raisons."), nl,
	write("Tu acceptes ton sort. Tu vas voir Charon, tu vas te faire juger et tu finis pour l'éternité a Asphodèle."), nl, 
	write("Tu ne reverra plus jamais Apollon."), nl, fin.
	
passage(arene_enfer, ouest, maison) :-
	write("La vue du disque d'Apollon fait remonter toute la tristesse qui est en toi."), nl, 
	write("Tu te mets en boule sous la table et tu pleures pendant des heures."), nl, 
	write("Tu en pleures tellement que tu en perds le cours du temps."), nl, 
...
passage(terrain_enfer, sud, palais) :-
	epreuve(nord, oui),
	write("Tu retournes au palais en ayant remporté l'épreuve du lancer de disque !"), nl.
	
passage(terrain_enfer, nord, palais) :-
	epreuve(nord, oui),
	write("Tu regardes la foule de spectateurs."), nl, 
	write("Tu te dis que personne ne pourrait te rattrapper à travers une telle foule."), nl, 
	write("Tu tentes de t'échapper en te glissant parmi la foule."), nl, 
	...
	write("Tu y es jeté pour l'éternité."), nl,
	fin.
...
passage(terrain_enfer, est, palais) :-
	...
	write("Sur le chemin de retour jusqu'au palais, tu tentes de t'échapper."), nl, 
	write("Tu cours tout droit vers l'Est, tu penses que rien ne peut t'arrêter."), nl, 
	write("Mais Cerbère te rattrape très vite et tu es jeté au Tartar sans plus D'explication."), nl,
	fin.

passage(terrain_enfer, ouest, palais) :-
	epreuve(nord, oui),
	write("Tu regardes Hadès."), nl, 
	write("Son sourire t'énerve."), nl, 
	write("Tu en as marre de tout ça."), nl,
...
passage(palais, est, salle_attente) :-
	epreuve(est, non),
	write("Tu choisis l'épreuve de la lutte."), nl,
	write("Une nymphe t'accueille et t'habille pour l'épreuve."), nl, 
	...
	write("Tu penses donc que la victoire sera facile puisque celui que tu affronteras sera fatigué."), nl.
...
passage(salle_attente, nord, salle_attente) :-
	write("Inconnu : Tu as l'air angoissé gamin."), nl, 
	write("Inconnu : Réjouis toi, au moins on ne peut pas en mourir ha ha ha ha !"), nl, 
	write("Ca ne te fait pas rire. L'inconnu reprend un air sérieux."), nl, 
	...
	write("Tu te décomposes. Comment battre le plus fort de tous les titans ?"), nl, 
...
passage(salle_attente, ouest, ring1) :-
	write("L'autre combattant est appelé. Il va se battre en passant par la lourde porte."), nl, 
	write("Tu attends encore un peu. Puis rapidement, après, c'est toi qui est appelé."), nl, 
	write("Le précédent combat a été très rapide, trop rapide."), nl, 
	write("Tu entres dans l'arène au bout de ce long couloir sombre."), nl, 
	write("La lumière t'aveugle. Le bruit de la foule est assourdissant."), nl, 
	write("Tu observes ton opposant sur le ring. Chronos, un grand sourir aux lèvres, t'attend pour votre combat."), nl.

passage(ring1, sud, ring2) :-
	write("Tu arrives à l'esquiver sans trop de difficulté."), nl.
...
passage(ring2, nord, ring3) :- 
	write("Tu esquives parfaitement son attaque."), nl.

passage(ring2, est, ring3) :-
	write("Tu ne te recules pas assez vite."), nl, 
	write("Tu te prends son crochet droit dans la machoire."), nl, 
	write("Cela te fait voir flou pendant plusieurs secondes."), nl, 
	changer_vie(-1).

passage(ring3, sud, ring4) :-
	write("Tu réussis à le frapper de toutes tes forces dans les cotes."), nl,
	write("Il siffle de douleur et sa main recouvre l'endroit de l'impact."), nl.

passage(ring3, ouest, ring4) :- 
	write("Tu tentes de te décaler mais il est beaucoup plus rapide que toi."), nl, 
	write("Il te fait un croche pied et tu tombes par terre."), nl, 
	write("Tu te relèves en étant rouge de honte."), nl, 
	changer_vie(-1).
	
% passage secret, il gagne une vie en plus
passage(ring3, est, ring4) :- 
	write("Tu le prends de vitesse et tu lui mets un coup de pied dans la tête."), nl, 
	write("Tu es toi même étonné que tu aies réussi à sauter assez haut."), nl, 
	write("Il tombe à terre, la tempe en sang."), nl, 
	write("Il se relève maladroitement mais rapidement."), nl, 
	changer_vie(1).

passage(ring4, nord, ring5) :- 
	write("Tu frappes de toutes tes forces directement dans sa main."), nl, 
	write("Il hurle de douleur et se tient la main."), nl.

passage(ring4, est, ring5) :-
	write("Tu lèves ta jambe pour le frapper, mais il est plus rapide que toi."), nl, 
	write("Il te prends par la jambe et te balance à l'autre bout du terrain."), nl, 
	write("Tu as mal au crane et les accalamtions de la foule n'aident pas."), nl, 
	write("Tu te relèves et te rapproches de lui alors qu'il salue la foule."), nl,
	changer_vie(-1).

passage(ring5, sud, ring6) :-
	write("Tu te décales et lui enfonces tes deux pouces dans les yeux."), nl, 
	write("Il hurle de douleur."), nl,
	write("Il te repousse et vous tombez tous les deux à terre."), nl.

passage(ring5, est, ring6) :-
	write("Tu charges ton poing pour l'attaque, mais il est plus rapide que toi."), nl, 
	write("Il te prend par la bras et tente de t'envoyer à l'autre bout du terrain."), nl, 
	write("Tu ne le laisses pas faire et tu t'appuies sur lui pour le faire basculer avec toi."), nl, 
...
passage(ring6, sud, palais) :-
	epreuve(est, oui),
	write("Tu retournes au palais en ayant remporté l'épreuve de la lutte !"), nl.
...
lancer(disque_apollon, ouest) :- % ouest car c'est la qu'est apollon dans la premiere arene 
	...
	write("Personne n'arrive à faire mieux que toi."), nl, 
	write("Tu gagnes haut la main cette épreuve."), nl,
	write("Pour te préparer à la suite, tu dois te rendre au palais qui se trouve au sud."), nl, 
	changer_epreuve(nord),
	lacher(disque_apollon),
	 !.
	
lancer(disque_bois, ouest) :-
	position(disque_bois, en_main),
	position_courante(terrain_enfer),
	write("Tu tires à l'ouest avec le disque en bois."), nl, 
...
lancer(disque_acier, ouest) :-
	...
	atom(X),
	position_courante(terrain_enfer),
	write("Tu tires à l'ouest avec le disque en acier."), nl, 
...
lancer(X, est) :- 
	...
	write("Tu perds l'épreuve en bon dernier."), nl,
	decrireFin.
	
lancer(X, nord) :-
	position(X, en_main),
	position_courante(terrain_enfer),
	write("Tu tires vers le nord."), nl, 
...
decrire(devant_stix) :- 
	...
	write("Hadès : C'est dommage, tu allais devenir un héro. C'est la vie, ou la mort plutôt."), nl,
	write("Hadès : Maintenant vas avec Charon, le jugement t'attend."), nl,
...
decrire(palais) :-
	...
	write("Tu te retrouves dans une grande pièce circulaire avec 3 portes devant toi."), nl, 
...
decrire(piste) :-
	...
	write("Tu te places sur le départ avec les chaussures d'Hermès aux pieds."), nl, 
...
decrire(piste) :-
	...
	write("Tu te places sur le départ avec les lourdes chaussures aux pieds."), nl,
	write("Hélas elles te ralentissent énormément dans ta course et tu perds en arrivant à la deuxième place."), nl, 
	decrireFin, !.

decrire(piste) :-
	\+ position(chaussure_hermes, en_main),
	position(petite_chaussure, en_main),
	write("Tu te places sur le départ avec les petites chaussures aux pieds."), nl,
	write("Hélas elles te font mal aux pieds et courir devient difficile."), nl, 
	write("Tu perds en arrivant à la deuxième place."), nl, 
	decrireFin, !.
...
decrire(piste) :- 
	...
	\+ position(petite_chaussure, en_main),
	\+ position(lourde_chaussure, en_main),
	write("Tu te places sur le départ sans chaussures aux pieds."), nl,
	write("Le public est hilare en te voyant pieds nus."), nl, 
	write("Tu effectues la course sans aucune gène aux pieds."), nl, 
	write("Grâce à cela, tu gagnes la course haut la main."), nl, 
...
decrire(arene_enfer) :-
	...
	write("Devant toi il y a une grand table où il ne reste plus que 3 disques :"), nl,
	...
	write("exactement comme celui qui a mit fin à tes jours ..."), nl, 
	write("Tu remarques un peu de sang séché dessus. Encore un coup sordide du dieu des morts."), nl, 
...
decrire(terrain_enfer) :- 
	...
	write("Au sud, parmi la foule tu remaques le roi Hadès et la reine Perséphone qui t'observent avec malice."), nl, 
	write("Cela t'inquiète, il y a surement un piège."), nl, 
	...
	write("Tu regardes Hadès, son sourir s'élargie."), nl, 
...
decrire(salle_attente) :-
	...
	write("Tu fais les 100 pas."), nl, 
	write("Au nord, il y a un autre combattant avec toi dans cette salle d'attente."), nl.
	% si on va lui parler on a 1 point en plus sur le compteur de vie 

decrire(ring1) :- 
	write("Tu entres sur le ring."), nl, 
	write("Le gong retenti. Le combat commence"), nl, 
	write("Chronos, deux fois plus grand que toi, te charge à l'ouest."), nl, 
	write("Tu peux l'esquiver en allant au sud, ou lui foncer dessus à l'ouest."), nl.
...
decrire(ring4) :- 
	write("Ses yeux s'assombrissent. Il en a marre de jouer et veut en finir vite."), nl, 
	write("Il ressemble à une bête sauvage."), nl,
	write("Il essaie de te prendre par le cou."), nl, 
	write("Tes jambes sont paralysées par la peur, tu ne pourras pas esquiver."), nl, 
	write("Tu peux frapper entre ses jambes à l'est"), nl, 
	write("ou tu peux frapper sur sa main qui vient du nord."), nl.

decrire(ring5) :-
	write("Tu vois une ouverture."), nl,
	write("Tu es assez proche pour lui mettre un gros coup dans l'abdomen à l'est,"), nl, 
	write("ou lui enfoncer les doigts dans les yeux en te décalant au sud."), nl.

decrire(ring6) :- % cas de victoire 
	vie(X), 
	X > 0,
	write("Tu te relèves plus vite que lui et tu lui mets un coup de pied dans la tempe."), nl, 
	write("Il tombe à terre. Sa tempe saigne. Il ne se relève pas."), nl, 
	write("Tu l'as vaincu."), nl, 
	write("La foule t'acclame et tu la salues."), nl, 
...
decrire(ring6) :- % cas de défaite 
	...
	write("Tu ne peux plus respirer et perds connaissance."), nl, 
	write("Tu te réveilles au palais d'Hadès. Tu as perdu l'épreuve."), nl, 
	decrireFin.
...
decrire(fin_parfaite) :- 
	write("Tu retrouves Apollon dans l'arène, au même endroit où tu es décédé. Il a l'air totalemnt vide."), nl,
	...
	write("Quelques mois plus tard, tu participes aux JO et tu les remportes haut la main."), nl, 
...
decrireFin :-
	...
	write("Cependant il sait être clément. Tu ne finiras pas au Tartar mais à Asphodèle."), nl, 
	write("Tu ne reverras plus jamais Apollon et tu ne deviendras jamais un héro."), nl,
	fin, !.
